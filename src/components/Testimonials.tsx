      ...
      setTestimonials([
        {
          ...
          content: 'Reprezentare juridică excepțională! Camelia Irina a gestionat cazul meu de drept comercial cu cea mai mare profesionalitate și a obținut un rezultat peste așteptările mele.',
          rating: 5,
        ...
        },
        {
          ...
          content: 'Serviciu remarcabil în dreptul imobiliar. Expertiza și dedicarea demonstrată pe parcursul tranzacției noastre complexe de proprietate a fost remarcabilă.',
          rating: 5,
          created_at: new Date().toISOString(),
          is_active: true
        }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl sm:text-5xl font-serif font-bold text-gray-900 mb-4">
            Ce spun <span className="text-yellow-600">clienții noștri</span>
          </h2>
